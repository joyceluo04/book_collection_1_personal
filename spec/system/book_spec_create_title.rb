...
RSpec.describe "Books", type: :system do
  ...
  it "adds a book title successfully and shows the correct flash notice" do
    visit books_path
    click_link "New book" 
  ...
  it "does not save a book with a nonblank title and shows rainy-day flash notice" do
    visit books_path
    click_link "New book"
